...
Variant while_instrT: Type :=
  | while_instr_skip
  | while_instr_assign (lhs:Id.t) (rhs:exprT)
  | while_instr_load (lhs:Id.t) (rhs:Loc.t) (ord:Ordering.t)
  | while_instr_store (lhs:Loc.t) (rhs:exprT) (ord:Ordering.t)
  | while_instr_fadd (lhs:Id.t) (loc:Loc.t) (addendum:exprT) (ordr ordw:Ordering.t)
  | while_instr_fence (ordr ordw:Ordering.t)
.
#[export]
Hint Constructors while_instrT: core.

Inductive while_stmtT :=
| while_stmt_instr (i:while_instrT)
| while_stmt_if (cond:exprT) (s1 s2:list while_stmtT)
| while_stmt_dowhile (s:list while_stmtT) (cond:exprT)
.
#[export]
Hint Constructors while_stmtT: core.
Coercion while_stmt_instr: while_instrT >-> while_stmtT.
